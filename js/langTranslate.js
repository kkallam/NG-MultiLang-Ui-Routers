...
myApp.config(['$translateProvider', function ($translateProvider) {
  ...
  $translateProvider.translations('en', {
		...
		FOOTERMSG1: 'Whether the client is a small business or a global brand, every engagement is a partnership',
		BUTTON_LANG_SP: 'Spanish',
		BUTTON_LANG_EN: 'English',
		CONTACT_QUESTIONS: 'Have a question or a special request?',
		EMAILUS: 'email us',
		SA: 'South Africa',
		SA_PARA1: 'South Africa, officially the Republic of South Africa (RSA), is the 25th-largest country in the world by land area, and with close to 56 million people, is the worlds 24th-most populous nation.',
		SA_PARA2: 'South Africa is a multiethnic society encompassing a wide variety of cultures, languages, and religions.Two of these languages are of European origin: Afrikaans developed from Dutch. English reflects the legacy of British colonialism.',
		SA_PARA3: 'South Africa is often referred to as the -Rainbow Nation- to describe the countrys multicultural diversity, especially in the wake of apartheid. The World Bank classifies South Africa as an upper-middle-income economy, and a newly industrialised country.',
		EMPLOYEES: 'Employees',
		EMPINFO: 'Employees Info Section',
		EMPASSET: 'Employees are a company\'s greatest asset - they\'re your competitive advantage. You want to attract and retain the best; provide them with encouragement, stimulus, and make them feel that they are an integral part of the company\'s mission.',
		AUTHORS: 'Authors page',
		AUTHINFO: 'This page shows a list of popular and recent authors and it is intended to show the use of Multiple Views.',
		WEL_UK: 'Welcome to UK Portal',
		DASHBOARD: 'Dashboard',
		VOLUME: 'Volume Info',
		LOS: 'LOS Info',
		RENEWAL: 'Renewal Info',
		AUSIS: 'Welcome to Australia',
		AUSIS_PARA1: 'Australia officially the Commonwealth of Australia, is a country comprising the mainland of the Australian continent, the island of Tasmania and numerous smaller islands. It is the world\'s sixth-largest country by total area.',
		AUSIS_PARA2: 'Australia has the world\'s 13th-largest economy and ninth-highest per capita income (IMF). With the second-highest human development index globally, the country ranks highly in quality of life, health, education, economic freedom, and civil liberties and political rights',
  ...
  $translateProvider.translations('sp', {
		...
		FOOTERMSG1: 'Para Tekzenit y sus empleados, la lealtad es una calle de dos vías',
		BUTTON_LANG_SP: 'Español',
		BUTTON_LANG_EN: 'Inglés',
		CONTACT_QUESTIONS: 'Tiene una pregunta o una petición especial?',
		EMAILUS: 'Envíanos un correo electrónico',
		SA: 'Sudáfrica',
		SA_PARA1: 'Sudáfrica, oficialmente la República de Sudáfrica (RSA), es el 25º país más grande del mundo por superficie terrestre, y con cerca de 56 millones de habitantes, es la 24ª nación más poblada del mundo.',
		SA_PARA2: 'Sudáfrica es una sociedad multiétnica que abarca una amplia variedad de culturas, idiomas y religiones. Dos de estas lenguas son de origen europeo: el afrikaans se desarrolló a partir del holandés. El inglés refleja el legado del colonialismo británico.',
		SA_PARA3: 'Sudáfrica se refiere a menudo como la "nación del arco iris" para describir la diversidad multicultural del país, especialmente después del apartheid. El Banco Mundial clasifica a Sudáfrica como una economía de ingresos medios-altos, y un país recientemente industrializado.',
		EMPLOYEES: 'Empleados',
		EMPINFO: 'Sección de Información de Empleados',
		EMPASSET: 'Los empleados son el mayor activo de una empresa: son su ventaja competitiva. Quieres atraer y retener lo mejor; Darles estímulo y hacerles sentir que son parte integral de la misión de la empresa.',
		AUTHORS: 'Página de autores',
		AUTHINFO: 'Esta página muestra una lista de autores populares y recientes y su intención es mostrar el uso de múltiples vistas.',
		WEL_UK: 'Bienvenido a UK Portal',
		DASHBOARD: 'Tablero',
		VOLUME: 'Información del volumen',
		LOS: 'Información de la LOS',
		RENEWAL: 'Información de Renovación',
		AUSIS: 'Bienvenido a Australia',
		AUSIS_PARA1: 'Australia oficialmente el Commonwealth de Australia, es un país que comprende el continente del continente australiano, la isla de Tasmania y numerosas islas más pequeñas. Es el sexto país más grande del mundo por área total.',
		AUSIS_PARA2: 'Australia tiene la decimotercera economía más grande del mundo y la novena más alta renta per cápita (FMI). Con el segundo mayor índice de desarrollo humano en todo el mundo, el país está muy bien en calidad de vida, salud, educación, libertad económica y libertades civiles y derechos políticos'
